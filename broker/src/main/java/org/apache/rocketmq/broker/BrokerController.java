...
public class BrokerController {
    ...
    protected final PopConsumeDeliveryStrategy popConsumeDeliveryStrategy;
    ...
    public BrokerController(
        ...
        this.popConsumeDeliveryStrategy = new PopConsumeDeliveryStrategy(this);
        ...
        this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    BrokerController.this.popConsumeDeliveryStrategy.persist();
                } catch (Throwable e) {
                    LOG.error(
    ...
    public boolean initializeMetadata() {
        ...
        result = result && this.popConsumeDeliveryStrategy.load();
        return result;
    }
    ...
    public PopConsumeDeliveryStrategy getConsumerOrderInfoManager() {
        return popConsumeDeliveryStrategy;
    }
    ...
    protected void shutdownBasicService() {
        ...
        if (this.popConsumeDeliveryStrategy != null) {
            this.popConsumeDeliveryStrategy.persist();
            this.popConsumeDeliveryStrategy.shutdown();
        }
